...
export default function CreateOrderScreen() {
 ...
 (addr.address_id || "") +
 (addr.full_address
 ? ` - ${addr.full_address.substring(0, 30)}...`
 : ""),
 value: addr.id,
 }));
 ...
 console.error("Failed to fetch party products:", products);
 ...
 if (!dispatchFrom) return Alert.alert("Error", "Select dispatch location");
 ...
 dispatch_from_name:
 dispatches.find((d) => d.value === dispatchFrom)?.label ?? "",
 ...
 // console.error('Error creating order:', JSON.stringify(response));
